    ...
    <main class="main media-page">
        <div class="container">
            <h1 class="header-title">медиа</h1>
            <div class="media-page__menu">
                <button class="media-page__btn active" id="photo-media">Фото</button>
                <button class="media-page__btn" id="video-media">Видео</button>
            </div>
            <div class="media-page__block">
                <div class="media-page__items" data-media="photo-media">
                    <a href="#" class="media-page__item">
                        <img class="media-page__photo" src="./img/photo-1.webp" alt="media photo">
                        <div class="media-page__wrap">
                            <p class="media-page__name">Спартак - Сопка Героев</p>
                            <div class="media-page__info">
                                <p>12 июля 2022</p>
                                <p>24 фото</p>
                            </div>
                        </div>
                    ...
                    <a href="#" class="media-page__item">
                        <img class="media-page__photo" src="./img/photo-2.webp" alt="media photo">
                        <div class="media-page__wrap">
                            <p class="media-page__name">Спартак - Сопка Героев</p>
                            <div class="media-page__info">
                                <p>12 июля 2022</p>
                    ...
                    <a href="#" class="media-page__item">
                        <img class="media-page__photo" src="./img/photo-3.webp" alt="media photo">
                        <div class="media-page__wrap">
                            <p class="media-page__name">Спартак - Сопка Героев</p>
                            <div class="media-page__info">
                                <p>12 июля 2022</p>
                ...
                <div class="media-page__items hidden" data-media="video-media">
                    <a href="#" class="media-page__item">
                        <div class="photo__wrap">
                            <img class="media-page__photo" src="./img/video-1.webp" alt="media video">
                    ...
                    <a href="#" class="media-page__item">
                        <div class="photo__wrap">
                            <img class="media-page__photo" src="./img/video-2.webp" alt="media video">
                            <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="15" cy="15" r="15" fill="#EDF6F9" />
                                <path
                                    d="M20.7 14.4338C21.3667 14.8187 21.3667 15.7809 20.7 16.1658L12.45 20.929C11.7833 21.3139 10.95 20.8327 10.95 20.0629V10.5367C10.95 9.76686 11.7833 9.28574 12.45 9.67064L20.7 14.4338Z"
                    ...
                    <a href="#" class="media-page__item">
                        <div class="photo__wrap">
                            <img class="media-page__photo" src="./img/video-3.webp" alt="media video">
                            <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="15" cy="15" r="15" fill="#EDF6F9" />
                                <path
                                    d="M20.7 14.4338C21.3667 14.8187 21.3667 15.7809 20.7 16.1658L12.45 20.929C11.7833 21.3139 10.95 20.8327 10.95 20.0629V10.5367C10.95 9.76686 11.7833 9.28574 12.45 9.67064L20.7 14.4338Z"
                ...
                <div class="adversting__contact news-page__contact media-page__contact">
