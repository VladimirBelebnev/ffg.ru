    ...
    <main class="sport-school main">
            <div class="container">
                <div class="sport-school__wrap">
                    <h1 class="header-title sport-school__header sport-school__header-mobile">спортшкола “Фортуна”</h1>
                    <img class="sport-school__photo" src="./img/fortuna.webp" alt="fortuna photo">
                    <div class="sport-school__content">
                        <h1 class="header-title sport-school__header">спортшкола “Фортуна”</h1>
<p class="sport-school__descr">Учредителем и собственником имущества муниципального бюджетного учреждения спортивная школа «Фортуна» является муниципальное образование город-курорт Геленджик.
...
Органом, осуществляющим отдельные функции и полномочия Учредителя, является управление по физической культуре и спорту администрации муниципального образования город-курорт Геленджик:Начальник управления — Давлетукаев Руслан Алиабасович (личный приём руководителя среда 15:00-18:00)</p>
                    </div>
                </div>
            </div>
            <div class="sport-school__contact">
                ...
                <div class="sport-school-contact__wrap">
                    <div class="sport-school-contact__block">
                        ...
                        <p class="sport-school-contact__info">г. Геленджик, ул.Гринченко, 31а</p>
                    </div>
                    <div class="sport-school-contact__block">
                        <svg class="sport-school-contact__icon" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="sport-school-contact__block">
                        ...
                        <a class="sport-school-contact__info" href="http://fortuna-gel.ru">http://fortuna-gel.ru</a>
                    </div>
                </div>
            </div>
        </main>
