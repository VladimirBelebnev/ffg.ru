    ...
    <main class="main media-page">
        <div class="container">
            ...
            <div class="media-page__menu">
                <a href="https://ffgel.ru/media-photo" class="media-page__btn" id="photo-media">Фото</a>
                <a href="https://ffgel.ru/media-video" class="media-page__btn active" id="video-media">Видео</a>
            </div>
                    ...
                    <div class="media-page__items">
                        <?php
                            ...
                            while( $the_query->have_posts() ){
                                $the_query->the_post();
                                ?>
                                    <a href="<?php the_field('video_url'); ?>" class="media-page__item">
