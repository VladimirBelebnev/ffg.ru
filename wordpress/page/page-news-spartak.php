    ...
    <main class="news-page main">
        <div class="container">
            ...
            <div class="news-page__menu">
                <a href="https://ffgel.ru/news" class="news-page__btn news-page__btn-all" id="all-news">Все</a>
                ...
                <div class="news-page__wrap">
                    <a href="https://ffgel.ru/news-spartak" class="news-page__btn news-page__btn-comand active" id="spartak">«Спартак Геленджик»</a>
