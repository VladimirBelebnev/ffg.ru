    ...
    <main class="main about">
        <div class="about__header">
            ...
            <img class="about__photo" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>">
            <div class="container">
                <div class="about-header__block">
                    <img class="about-header__logo" src="<?php echo get_template_directory_uri(); ?>/assets/img/footer-logo.svg" alt="logo">
                    <h1 class="about-header__title">Геленджикская городская общественная организация «Федерация футбола города-курорта Геленджик»</h1>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="about__block">
                ...
                <div class="about__descr"><?php the_field('about_content'); ?></div>
            </div>
            <div class="about__block">
                <h2 class="title">История футбола Геленджика</h2>
                <div class="about__descr"><?php the_field('history_content'); ?></div>
            </div>
            <div class="about__block">
                ...
                <div class="about__wrap">
                    <div class="about-regalia__block">
                        <div class="about-regalia__photo">
                            <?php $ruk1 = get_field('about_ruk-1'); ?>
                            <img src="<?php echo $ruk1['url']; ?>" alt="<?php echo $ruk1['alt']; ?>">
                        </div>
                    ...
                    <div class="about-regalia__block">
                        <div class="about-regalia__photo">
                             <?php $ruk2 = get_field('about_ruk-2'); ?>
                            <img src="<?php echo $ruk2['url']; ?>" alt="<?php echo $ruk2['alt']; ?>">
                        </div>
                        <div class="about-regalia__regalia">
        ...
        <div class="sport-school__contact about__contact">
            ...
            <div class="sport-school-contact__wrap">
                ...
                <div class="sport-school-contact__block">
                    ...
                    <a class="sport-school-contact__info" href="callto:+7(999)999-99-99">+7 (999) 999-99-99</a>
                </div>
                <div class="sport-school-contact__block">
                    ...
                    <a class="sport-school-contact__info" href="mailto:ffgel@mail.ru">ffgel@mail.ru</a>
                </div>
            </div>
        </div>
    </main>
