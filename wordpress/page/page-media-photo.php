    ...
    <main class="main media-page">
        <div class="container">
            ...
            <div class="media-page__menu">
                <a href="https://ffgel.ru/media-photo" class="media-page__btn active" id="photo-media">Фото</a>
                <a href="https://ffgel.ru/media-video" class="media-page__btn" id="video-media">Видео</a>
            </div>
                    ...
                    <div class="media-page__items">
                        <?php
                            ...
                            while( $the_query->have_posts() ){
                                $the_query->the_post();
                                ?>
                                    <a href="<?php the_permalink(); ?>" class="media-page__item">
                                        <?php $image = get_field('main-photo_thumbnail'); ?>
                                        <img class="media-page__photo" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>">
                                        <div class="media-page__wrap">
                                            <p class="media-page__name"><?php the_title(); ?></p>
                                            <div class="media-page__info">
                                                <p><?php the_time('j F Y'); ?></p>
                                                <p><?php the_field('photo_total'); ?> фото</p>
                                            </div>
                                        </div>
                                    </a>
                                <?php
