		...
		<div class="header__block">
			<div class="container">
				...
				<ul class="header__block-nav">
					...
					<li style="display: inline-block;"><a class="nav__link-img" href="#slider"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/header-logo.svg" alt="logo"></a></li>
					<li class="nav__link">
				...
				<a class="mobile__logo" href="#slider"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/header-logo.svg" alt="logo"></a>
