...
const slider = () => {
  const sliderSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider__slider', {
  ...
  const calendarSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.calendar__slider', {
    direction: 'horizontal',
    loop: true,
    slidesPerView: 3,
    pagination: {
...
const tournamentsTabs = () => {
  ...
  const links = document.querySelectorAll('.tournaments__link'); // links.forEach(link => {
  //     link.addEventListener('click', function () {
